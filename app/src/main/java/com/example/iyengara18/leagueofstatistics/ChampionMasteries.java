...
public class ChampionMasteries extends Fragment implements LoaderManager.LoaderCallbacks<List<ChampMasteryInfo>>{
    ...
    private static String REQUEST_MASTERY_URL="https://na1.api.riotgames.com/lol/champion-mastery/v3/champion-masteries/by-summoner/"+Info_Tab_Layout.summonerId+"?api_key="+API_KEY;
